...
{
    std::cout << "ctor SingleCycleWaveform" << std::endl; 
...
{
    std::cout << "dtor SingleCycleWaveform" << std::endl; 
}
...
{
    std::cout << "ctor Oscillator" << std::endl;
}

Oscillator::~Oscillator()
{
    std::cout << "dtor Oscillator" << std::endl; 
}
